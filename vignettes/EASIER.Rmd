...
Like in the Quality Control module of the EASIER R package, in the Meta-analysis module we need to define some initial variables, which are specific to each study \textcolor{red}{(this is the only part of the code that requires editing!)}. These variables are:
...
```{r manhat, echo=FALSE, out.width='70%',  fig.align='center',  fig.cap="\\label{fig:manhat}Manhattan plot obtained with GWAMA ", fig.pos='ht'}
...
```{r heteroi2, echo=FALSE, out.width='70%',  fig.align='center',  fig.cap="\\label{fig:heteroi2}Heterogeneity distribution plot (i2) ", fig.pos='ht'}
