...
------- | ----- | ----- | -----
cg13869341 | 0.00113640479983364 | 0.00963113128153573 | 0.906073309096263
cg24669183 | -0.0295105946089182 | 0.0150948404044624 | 0.0505816501551891
cg15560884 | 0.00232510627603938 | 0.00638784678105962 | 0.715866186815538
...
This code is executed for each file defined in previous variable `files`
...
```{r QC_code_removedupli}
   ...
   cohort <- remove_duplicate_CpGs(cohort, "probeID", 
                                   paste0(results_folder,'/',prefixes[i],'_descriptives_duplic.txt'), 
                                   paste0(results_folder,'/',prefixes[i],'_duplicates.txt') )
```
