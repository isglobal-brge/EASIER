...
In QC process, we exclude that CpGs that not accomplish with defined parameters (Chen et al. (2013)), this parameters are defined in a character vector and are :
  ...
  * **Unrel_450_EPIC_blood**  : Unreliable probes discordant between 450K and EPIC for blood
  * **Unrel_450_EPIC_pla**  : Unreliable probes discordant between 450K and EPIC for placenta
  * **Unrel_450_EPIC_pla_restrict**  : Unreliable probes discordant between 450K and EPIC for placenta (more restrictive)
  * **MASK_rmsk15** :  
